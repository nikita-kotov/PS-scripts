...
$Username = "svc_VMWare_Alert@angaratech.ru" #user with permissions for vSphere and mail service
$Password = 'aVr^_f[`[p3<qrDL'
$Credentials = New-Object System.Management.Automation.PSCredential ($Username, (ConvertTo-SecureString $Password -AsPlainText -Force))
$Theme = "Отчет по ресурсному пулу отдела"
$SenderEmail = "VMWare_Alert@angaratech.ru"
$SMTPServer = "mbx.angaratech.ru"
$SMTPPort = "465"
$vSphereServer = "nxvcenter.angaratech.ru"
$ResourcePool = "Labs" #you get a report for this pool
$ManagersGroupDN = "CN=Отчеты по потреблению ресурсов,OU=Groups,DC=angaratech,DC=ru" #Distinguished name of group with  managers
$AdminMail = "kotovna@angarasecurity.ru"
...
function New-ManagerReport {
    ...
    $OwnerVMs = $VMs|where {$_.value -eq $Mail}
        ...
        ForEach ($user in $DirectReports) {
            ...
            Send-MailMessage -From $SenderEmail -to $AdminMail -Subject $Theme -BodyAsHtml $Body -Credential $Credentials -SmtpServer $SMTPServer -Port $SMTPPort -Encoding utf8}
